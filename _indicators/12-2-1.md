...
target: 'Do 2030. postici održivo upravljanje i ucinkovito korištenje prirodnih resursa.'
...
indicator_definition: 'Materijalni otisak(MF) pripisuje se globalnom vadenju materijala na domacu finalnu potražnju neke zemlje. Izracunava se kao ekvivalent sirovina za uvoz (RMEIM) plus domace vadenje (DE) minus ekvivalent sirovina za izvoz(RMEEX). Za dodjeljivanje primarnih'
