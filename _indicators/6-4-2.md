...
graph: longitudinal
graph_negative:
graph_title: Razina vodenog stresa - zahvaćanje slatke vode 
kao udio raspoloživih slatkovodnih resursa (%)
has_metadata: true
indicator: 6.4.2
...
indicator_variable: Razina vodenog stresa - zahvaćanje slatke vode 
kao udio raspoloživih slatkovodnih resursa (%)
layout: indicator
periodicity:
permalink: /6-4-2/
...
un_custodial_agency: |
  "FAO  (Partnering  Agencies -  UNEP,  IUCN,  UNSD,  OECD,  Eurostat)
