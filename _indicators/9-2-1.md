...
graph: longitudinal
graph_negative:
graph_title: Bruto dodana vrijednost prerađivačke industrije - udio u BDP-u (%)
has_metadata: true
indicator: 9.2.1
...
indicator_variable: Bruto dodana vrijednost prerađivačke industrije - udio u BDP-u (%)
layout: indicator
periodicity: Annual
permalink: /9-2-1/
published: true
...
un_custodial_agency: |
  "UNIDO  (Partnering  Agencies -  World  Bank)
